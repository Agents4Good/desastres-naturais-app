...
//   Future<String> _loadContigencePlan() async {
//     return await rootBundle.loadString('assets/PlanodeContingencia-CampinaGrande2023.txt');
//   }
...
//     _loadContigencePlan().then((contigencePlan) {
//       if (isEn) {
