...
final appRouteNameToIcon = {
  AppRoute.home.name: const UnpackedRouteBase(icon: Icon(Icons.house), text: "Home"),
  AppRoute.chat.name: const UnpackedRouteBase(icon: Icon(Icons.chat), text: "Chat"),
  AppRoute.map.name: const UnpackedRouteBase(icon: Icon(Icons.map_outlined), text: "Mapa"),
  AppRoute.forecast.name: const UnpackedRouteBase(icon: Icon(Icons.cloudy_snowing), text: "Previsões"),
  AppRoute.settings.name: const UnpackedRouteBase(icon: Icon(Icons.settings), text: "Configurações"),
};
...
GoRouter goRouter(Ref ref) {
  ...
  return GoRouter(
    ...
    routes:[
      ShellRoute(
        builder: (context, state, child) => AppLayout(child: child, routes: routes),
        routes: routes
      ),
    ],
