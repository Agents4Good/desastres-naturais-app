        ...
        child: Column(
          ...
          children: [
            ...
            _NavigationCard(
              ...
              subtitle: 'Navegue por uma gama de modelos que rodam localmente no seu dispostivo!',
            ...
            _NavigationCard(
              title: '[DEBUG] Modelo default',
              subtitle: 'Modelo default para fins de debugging',
              icon: Icons.model_training,
              color: Colors.blue,
              onTap: () {
                Navigator.push(
